...
public class InfluenceListResult {
    ...
    public InfluenceListResult(Long id, String nickname, String name, String email, String phoneNumber, String extensionNumber, Rank rank, Boolean isHotInfluence,
