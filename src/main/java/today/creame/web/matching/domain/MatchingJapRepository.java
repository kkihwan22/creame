...
public interface MatchingJapRepository extends JpaRepository<Matching, Long> {
    ...
    Optional<Matching> findByInfluenceAndMemberAndStatusAndStartDateTimeEquals(Influence influence, Member member, MatchingProgressStatus status, LocalDateTime startDateTime);
