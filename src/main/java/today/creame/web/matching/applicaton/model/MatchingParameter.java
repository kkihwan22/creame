...
public class MatchingParameter {
    ...
    public MatchingParameter(String uid, String cid, String callId, MatchingProgressStatus matchingProgressStatus, LocalDateTime startDateTime, LocalDateTime endDateTime, boolean deferred, Integer usedCoins, PaidType paidType) {
        this.uid = uid;
        this.cid = cid;
        this.callId = callId;
